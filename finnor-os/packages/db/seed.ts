  ...
  try {
    ...
    await client.query(
      `INSERT INTO domain_policies (tenant_id, action_type, policy, requires_confirmation, confirmation_template)
       ...
       FROM (VALUES ('search_web'), ('scan_competitors'), ('check_business_reviews'), ('check_stock_level'), ('flag_reorder_needed'), ('check_technician_availability'), ('answer_water_question'), ('get_business_overview'), ('summarize_ad_performance')) AS t(action_type)
