...
describe("P1 locked deterministic Operational IR corpus", () => {
  it("locks every audited P1 semantic category, fixture hash, selector, clock, and seed", () => {
    ...
    expect(manifest.baselineSha).toBe("d87a256e87d9a2f4308135dd8383848a6b137b85");
    ...
    expect(manifest.cases.reduce((count, entry) => count + entry.selectors.length, 0)).toBe(71);
