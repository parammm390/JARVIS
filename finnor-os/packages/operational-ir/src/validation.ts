...
export function validateOperationalProgram(input: unknown): IrValidationResult {
  ...
  if (program.executionModel === "ATOMIC_ACTION"
  ...
  if (program.executionModel === "CLARIFY") {
    issue("ERROR", "CLARIFY_IR_NOT_APPLICABLE", "executionModel", "CLARIFY requests missing intent/grounding and does not produce executable Operational IR");
  }
