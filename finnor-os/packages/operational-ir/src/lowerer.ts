...
export function lowerOperationalProgram(
  ...
  if (program.executionModel === "CLARIFY") return unsupported(["CLARIFY produces a clarification request, not an Operational IR executable representation."], "NOT_APPLICABLE");
