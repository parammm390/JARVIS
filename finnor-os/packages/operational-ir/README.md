...
| --- | --- | --- | --- |
| `CompiledHumanOperation` | `LOSSY` | `NOT_APPLICABLE` | Preserves route/capability/target/date/payload, but lacks Goal, dependencies, observations, and success semantics. |
...
- ATOMIC_ACTION, including a system-known-action candidate -> draft `DomainAction` plan using
