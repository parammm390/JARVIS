...
const FINAL_COMPOSITION_PATHS = new Set([
  ...
  "scripts/release/capture-production-state.mjs",
  ...
  "scripts/release/rollback-production.mjs",
  ...
  "finnor-os/packages/orchestration/src/planner.ts",
  "finnor-os/packages/domain-plugins/crm/index.ts",
  "finnor-os/packages/domain-plugins/shared/db-helpers.ts",
