...
export const GOLDEN_JOURNEYS = Object.freeze([
  ...
  { id: "external-wait", entrypoint: "rail", expectedModels: ["OBJECTIVE"], instruction: "Wait for the external certification response before deciding whether this objective is complete. {nonce}" },
  { id: "external-wake", entrypoint: "rail", expectedModels: ["OBJECTIVE"], instruction: "Wait for and resume after the external certification event, then verify the objective. {nonce}" },
  { id: "blocked-objective", entrypoint: "rail", expectedModels: ["OBJECTIVE"], instruction: "Own this certification objective, but stop in a blocked state if the required integration is unavailable. {nonce}" },
  { id: "provider-unavailable", entrypoint: "rail", expectedModels: ["OBJECTIVE"], instruction: "Recover from a certification provider outage and report the integration state without claiming delivery. {nonce}" },
  ...
  { id: "failed-action-recovery", entrypoint: "rail", expectedModels: ["OBJECTIVE"], instruction: "Recover and reconcile the certification action after a failed provider attempt; do not claim success without evidence. {nonce}" },
  { id: "completed-verified-outcome", entrypoint: "rail", expectedModels: ["OBJECTIVE"], instruction: "Complete the certification objective only after a verified canonical outcome and receipt are observed. {nonce}" },
  { id: "computer-write-approval", entrypoint: "rail", expectedModels: ["OBJECTIVE"], control: "approval", instruction: "Use the certification computer workflow to perform a WRITE only behind approval and then verify it. {nonce}" },
