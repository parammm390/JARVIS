...
export const GOLDEN_JOURNEYS = Object.freeze([
  ...
  { id: "atomic-email", entrypoint: "rail", expectedModels: ["ATOMIC_ACTION"], instruction: "Send this exact certification message to certification@example.invalid: Product Truth atomic email {nonce}" },
  { id: "atomic-crm", entrypoint: "rail", expectedModels: ["ATOMIC_ACTION"], instruction: "Update the CRM record for certification@example.invalid with marker {nonce}" },
  ...
  { id: "ambiguous-customer", entrypoint: "rail", expectedModels: ["CLARIFY"], instruction: "Find the customer named Alex and ask me which canonical record to use. {nonce}" },
