...
# systemd-analyze loads other host units too. A broken distro/snap unit must not
# abort a FINNOR release before our worker even starts. Fail only when diagnostics
# actually name FINNOR's unit; keep unrelated host diagnostics visible.
