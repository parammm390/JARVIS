...
| planner live evaluation | FAIL; initial Preview provider-backed run scored 11/41 passed, 29 failed, 1 errored; after explicit Groq route pins and a 30-second provider pace, the complete recheck scored 17/41 passed, 9 failed, 15 errored — `p0-t6-planner-live-eval.txt`, `p0-t6-planner-live-eval-paced-recheck.txt` |
