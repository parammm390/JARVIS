...
function StageContent() {
  ...
  return (
    <div className="jarvis-root min-h-screen space-y-5 bg-[color:var(--j-bg)] p-6">
      ...
      <div id="flow-pipeline-theater">
        <MountToggle id="flow-pipeline-theater" label="FLOW-59..66">
          <PipelineTheaterCatalogSection />
        </MountToggle>
      </div>
      <div id="flow-dataviz">
      ...
      <div id="flow-voice-theater">
        <MountToggle id="flow-voice-theater" label="FLOW-67..73">
          <VoiceTheaterCatalogSection />
        </MountToggle>
      </div>
