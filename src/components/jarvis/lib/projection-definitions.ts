import { jarvisClient, type ActivityPage, type Household360Projection, type HouseholdResource, type InvoiceResource, type Vitals, type WorkCaseProjection } from "@/lib/jarvis-client"
...
export const businessProjections = {
  ...
  stockRisk: (): ProjectionDefinition<StockRisk> => ({ key: ["read-model", "stock-risk"], owner: "data-core.slow", staleMs: PROJECTION_FRESHNESS.slow, pollMs: 90_000, tags: ["work", "queries"], load: async () => (await jarvisClient.readModel("stock-risk")).data }),
