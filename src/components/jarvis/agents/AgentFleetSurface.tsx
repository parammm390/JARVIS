    ...
    <main className="jarvis-agent-fleet-shell" data-jarvis-agent-fleet data-inspector-state={inspector ? "open" : "closed"}>
      ...
      <section className="jarvis-agent-fleet__intro">
        <div>
          ...
          <h1>Five real calling agents. Fifty-eight registered actions.</h1>
          <p>The Vapi fleet stays distinct from the backend capability map. Nine code-backed domains organize the 58 registered actions; they are operating taxonomy, not extra agents.</p>
        </div>
        <div className="jarvis-agent-fleet__intro-signal" data-source="registered-action-contracts">
          <Waves size={18} aria-hidden />
          <span><strong>{REGISTERED_BACKEND_ACTION_COUNT} registered actions</strong><small>25 backend plugins · 9 capability domains · 5 calling agents</small></span>
        </div>
      </section>
      ...
      <div className="jarvis-agent-fleet__layout">
        <aside className="jarvis-agent-fleet__rail" aria-label="Capability domains" data-agent-fleet-rail>
          <div className="jarvis-agent-fleet__rail-heading"><span>CAPABILITY DOMAINS</span><strong>58-action map</strong></div>
