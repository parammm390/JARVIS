...
export const metadata: Metadata = {
  ...
  description:
    "Build a two-year customer lifecycle on live public water data: the inbound call, the real water record, the sizing math, the range at your prices, the booked visit, the documented job, the review, the check-ins, the referral, and the upsell, all as one continuous memory.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "The call was minute one. Watch one customer record evolve across two years with real water data, real sizing math, and one continuous memory.",
