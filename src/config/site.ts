export const siteConfig = {
  ...
  description:
    "Turn missed calls, after-hours inquiries, overflow calls, and slow web leads into booked water tests, service appointments, or urgent owner/on-call routes.",
  ...
  calendlySupport:
    "We will review where leads are leaking and scope a 7-day booking and lead recovery pilot around your front office.",
  links: {
